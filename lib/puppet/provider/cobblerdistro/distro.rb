...
Puppet::Type.type(:cobblerdistro).provide(:distro) do
  ...
  def create
    ...
    if @resource[:path]
      ...
      # TODO: we should only remove the profile generated by 'cobbler import',
      # if Puppet::Util::Package.versioncmp(cobbler_version, '2.7.0') < 0
      #
      # that is, if cobbler version is < 2.7.0.
      # After 2.7.0 no profile is generated on import
